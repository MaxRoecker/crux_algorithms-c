...
CRUX__ResultIU08 CRUX__cast_iu08_flp1 (const FLP1 value) {
  ...
  const bool has_overflow = (IU08_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP1(0));
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIU08 CRUX__cast_iu08_flp2 (const FLP2 value) {
  ...
  const bool has_overflow = (IU08_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP2(0));
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIU08 CRUX__cast_iu08_flp4 (const FLP4 value) {
  ...
  const bool has_overflow = (IU08_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP4(0));
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIU16 CRUX__cast_iu16_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU16_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP1(0));
  if (has_overflow) {
...
CRUX__ResultIU16 CRUX__cast_iu16_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU16_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP2(0));
  if (has_overflow) {
...
CRUX__ResultIU16 CRUX__cast_iu16_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU16_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP4(0));
  if (has_overflow) {
...
CRUX__ResultIU32 CRUX__cast_iu32_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU32_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP1(0));
  if (has_overflow) {
...
CRUX__ResultIU32 CRUX__cast_iu32_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU32_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP2(0));
  if (has_overflow) {
...
CRUX__ResultIU32 CRUX__cast_iu32_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU32_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP4(0));
  if (has_overflow) {
...
CRUX__ResultIU64 CRUX__cast_iu64_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU64_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP1(0));
  if (has_overflow) {
...
CRUX__ResultIU64 CRUX__cast_iu64_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU64_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP2(0));
  if (has_overflow) {
...
CRUX__ResultIU64 CRUX__cast_iu64_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IU64_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value)
    || (value < INT_AS_FLP4(0));
  if (has_overflow) {
...
CRUX__ResultIS08 CRUX__cast_is08_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS08_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS08 CRUX__cast_is08_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS08_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS08 CRUX__cast_is08_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS08_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS16 CRUX__cast_is16_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS16_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS16 CRUX__cast_is16_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS16_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS16 CRUX__cast_is16_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS16_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS32 CRUX__cast_is32_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS32_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS32 CRUX__cast_is32_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS32_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS32 CRUX__cast_is32_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS32_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS64 CRUX__cast_is64_flp1 (const FLP1 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP1 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS64_INT_PRECISION < log2f(fabsf(value)))
    || ((value != INT_AS_FLP1(0)) && (fabsf(value) < FLP1_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS64 CRUX__cast_is64_flp2 (const FLP2 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP2 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS64_INT_PRECISION < log2(fabs(value)))
    || ((value != INT_AS_FLP2(0)) && (fabs(value) < FLP2_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
...
CRUX__ResultIS64 CRUX__cast_is64_flp4 (const FLP4 value) {
  ...
  const CRUX__Occurrence *occurrences = NULL;
  const FLP4 truncated = FLP_TRUNC(value);
  const bool has_overflow = (IS64_INT_PRECISION < log2l(fabsl(value)))
    || ((value != INT_AS_FLP4(0)) && (fabsl(value) < FLP4_SMALLEST))
    || (truncated != value);
  if (has_overflow) {
    const CRUX__Error *const error = &CRUX__ERROR__INTEGER_CAST;
