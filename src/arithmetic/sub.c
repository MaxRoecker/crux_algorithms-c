...
CRUX__ResultIU08 CRUX_ARITH__sub_iu08_iu08 (
  ...
  CRUX__ResultIU08 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIU16 CRUX_ARITH__sub_iu08_iu16 (
  ...
  CRUX__ResultIU16 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIU32 CRUX_ARITH__sub_iu08_iu32 (
  ...
  CRUX__ResultIU32 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIU64 CRUX_ARITH__sub_iu08_iu64 (
  ...
  CRUX__ResultIU64 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIS16 CRUX_ARITH__sub_iu08_is16 (
  ...
  CRUX__ResultIS16 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIS32 CRUX_ARITH__sub_iu08_is32 (
  ...
  CRUX__ResultIS32 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIS64 CRUX_ARITH__sub_iu08_is64 (
  ...
  CRUX__ResultIS64 result = {.trace = trace, .value = sub};
  return result;
}
...
CRUX__ResultIS08 CRUX_ARITH__sub_is08_is08 (
  ...
  CRUX__ResultIS08 result = {.trace = trace, .value = sub};
  return result;
}
