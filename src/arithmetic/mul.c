...
CRUX__ResultIU16 CRUX_ARITH__mul_iu08_iu16 (
    const IU08 a, const IU16 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU08 multiplication = CRUX__as_iu16(0);
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      (b_promo != 0) && (a_promo > (IU16_MAX / b_promo));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu08_iu32 (
    const IU08 a, const IU32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU08 multiplication = CRUX__as_iu32(0);
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      (b_promo != 0) && (a_promo > (IU32_MAX / b_promo));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu08_iu64 (
    const IU08 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU08 multiplication = CRUX__as_iu64(0);
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      (b_promo != 0) && (a_promo > (IU64_MAX / b_promo));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIU08 CRUX_ARITH__mul_iu08_is08 (
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      (b_promo != 0) && (a_promo > (IU08_MAX / b_promo));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIS16 CRUX_ARITH__mul_iu08_is16 (
    const IU08 a, const IS16 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU08 multiplication = CRUX__as_is16(0);
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      ((a_promo > 0) && (b_promo > 0) && (a_promo > (IS16_MAX / b_promo)))
      || ((a_promo > 0) && (b_promo < 0) && (b_promo < (IS16_MIN / a_promo)))
      || ((a_promo < 0) && (b_promo > 0) && (a_promo < (IS16_MIN / b_promo)))
      || ((a_promo < 0) && (b_promo < 0) && (a_promo != 0) && (b_promo < (IS16_MAX / a_promo)));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIS32 CRUX_ARITH__mul_iu08_is32 (
    const IU08 a, const IS32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU08 multiplication = CRUX__as_is32(0);
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      ((a_promo > 0) && (b_promo > 0) && (a_promo > (IS32_MAX / b_promo)))
      || ((a_promo > 0) && (b_promo < 0) && (b_promo < (IS32_MIN / a_promo)))
      || ((a_promo < 0) && (b_promo > 0) && (a_promo < (IS32_MIN / b_promo)))
      || ((a_promo < 0) && (b_promo < 0) && (a_promo != 0) && (b_promo < (IS32_MAX / a_promo)));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIS64 CRUX_ARITH__mul_iu08_is64 (
    const IU08 a, const IS64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU08 multiplication = CRUX__as_is64(0);
  ...
  if (!CRUX__trace_check(promo_result.trace)) {
    ...
    const Bool has_overflow = 
      ((a_promo > 0) && (b_promo > 0) && (a_promo > (IS64_MAX / b_promo)))
      || ((a_promo > 0) && (b_promo < 0) && (b_promo < (IS64_MIN / a_promo)))
      || ((a_promo < 0) && (b_promo > 0) && (a_promo < (IS64_MIN / b_promo)))
      || ((a_promo < 0) && (b_promo < 0) && (a_promo != 0) && (b_promo < (IS64_MAX / a_promo)));
    if (has_overflow) {
      CRUX__Fault fault = {
        .error = CRUX_ARITH__ERROR_ARITHMETIC,
        .filepath = __FILE__,
...
CRUX__ResultIU16 CRUX_ARITH__mul_iu16_iu08 (
...
CRUX__ResultIU16 CRUX_ARITH__mul_iu16_iu16 (
    const IU16 a, const IU16 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU16 multiplication = CRUX__as_iu16(0);
  const Bool has_overflow = (b != 0) && (a > (IU16_MAX / b));
  if (has_overflow) {
    CRUX__Fault fault = {
      .error = CRUX_ARITH__ERROR_ARITHMETIC,
      .filepath = __FILE__,
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu16_iu32 (
    const IU16 a, const IU32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU16 multiplication = CRUX__as_iu32(0);
  CRUX__ResultIU32 promo_result = CRUX__cast_to_iu32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu16_iu64 (
    const IU16 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU16 multiplication = CRUX__as_iu64(0);
  CRUX__ResultIU64 promo_result = CRUX__cast_to_iu64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU16 CRUX_ARITH__mul_iu16_is08 (
...
CRUX__ResultIU16 CRUX_ARITH__mul_iu16_is16 (
...
CRUX__ResultIS32 CRUX_ARITH__mul_iu16_is32 (
    const IU16 a, const IS32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU16 multiplication = CRUX__as_is32(0);
  CRUX__ResultIS32 promo_result = CRUX__cast_to_is32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS64 CRUX_ARITH__mul_iu16_is64 (
    const IU16 a, const IS64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU16 multiplication = CRUX__as_is64(0);
  CRUX__ResultIS64 promo_result = CRUX__cast_to_is64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu32_iu08 (
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu32_iu16 (
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu32_iu32 (
    const IU32 a, const IU32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU32 multiplication = CRUX__as_iu32(0);
  const Bool has_overflow = (b != 0) && (a > (IU32_MAX / b));
  if (has_overflow) {
    CRUX__Fault fault = {
      .error = CRUX_ARITH__ERROR_ARITHMETIC,
      .filepath = __FILE__,
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu32_iu64 (
    const IU32 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU32 multiplication = CRUX__as_iu64(0);
  CRUX__ResultIU64 promo_result = CRUX__cast_to_iu64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu32_is08 (
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu32_is16 (
...
CRUX__ResultIU32 CRUX_ARITH__mul_iu32_is32 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_iu32_is64 (
    const IU32 a, const IS64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IU32 multiplication = CRUX__as_is64(0);
  CRUX__ResultIS64 promo_result = CRUX__cast_to_is64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_iu08 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_iu16 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_iu32 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_iu64 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_is08 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_is16 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_is32 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_iu64_is64 (
...
CRUX__ResultIU08 CRUX_ARITH__mul_is08_iu08 (
    const IS08 a, const IU08 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_iu08(0);
...
CRUX__ResultIU16 CRUX_ARITH__mul_is08_iu16 (
    const IS08 a, const IU16 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_iu16(0);
  CRUX__ResultIU16 promo_result = CRUX__cast_to_iu16(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU32 CRUX_ARITH__mul_is08_iu32 (
    const IS08 a, const IU32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_iu32(0);
  CRUX__ResultIU32 promo_result = CRUX__cast_to_iu32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU64 CRUX_ARITH__mul_is08_iu64 (
    const IS08 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_iu64(0);
  CRUX__ResultIU64 promo_result = CRUX__cast_to_iu64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS08 CRUX_ARITH__mul_is08_is08 (
...
CRUX__ResultIS16 CRUX_ARITH__mul_is08_is16 (
    const IS08 a, const IS16 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_is16(0);
  CRUX__ResultIS16 promo_result = CRUX__cast_to_is16(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS32 CRUX_ARITH__mul_is08_is32 (
    const IS08 a, const IS32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_is32(0);
  CRUX__ResultIS32 promo_result = CRUX__cast_to_is32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS64 CRUX_ARITH__mul_is08_is64 (
    const IS08 a, const IS64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS08 multiplication = CRUX__as_is64(0);
  CRUX__ResultIS64 promo_result = CRUX__cast_to_is64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS16 CRUX_ARITH__mul_is16_iu08 (
...
CRUX__ResultIU16 CRUX_ARITH__mul_is16_iu16 (
    const IS16 a, const IU16 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS16 multiplication = CRUX__as_iu16(0);
  CRUX__ResultIU16 promo_result = CRUX__cast_to_iu16(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU32 CRUX_ARITH__mul_is16_iu32 (
    const IS16 a, const IU32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS16 multiplication = CRUX__as_iu32(0);
  CRUX__ResultIU32 promo_result = CRUX__cast_to_iu32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU64 CRUX_ARITH__mul_is16_iu64 (
    const IS16 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS16 multiplication = CRUX__as_iu64(0);
  CRUX__ResultIU64 promo_result = CRUX__cast_to_iu64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS16 CRUX_ARITH__mul_is16_is08 (
...
CRUX__ResultIS16 CRUX_ARITH__mul_is16_is16 (
...
CRUX__ResultIS32 CRUX_ARITH__mul_is16_is32 (
    const IS16 a, const IS32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS16 multiplication = CRUX__as_is32(0);
  CRUX__ResultIS32 promo_result = CRUX__cast_to_is32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS64 CRUX_ARITH__mul_is16_is64 (
    const IS16 a, const IS64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS16 multiplication = CRUX__as_is64(0);
  CRUX__ResultIS64 promo_result = CRUX__cast_to_is64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS32 CRUX_ARITH__mul_is32_iu08 (
...
CRUX__ResultIS32 CRUX_ARITH__mul_is32_iu16 (
...
CRUX__ResultIU32 CRUX_ARITH__mul_is32_iu32 (
    const IS32 a, const IU32 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS32 multiplication = CRUX__as_iu32(0);
  CRUX__ResultIU32 promo_result = CRUX__cast_to_iu32(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIU64 CRUX_ARITH__mul_is32_iu64 (
    const IS32 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS32 multiplication = CRUX__as_iu64(0);
  CRUX__ResultIU64 promo_result = CRUX__cast_to_iu64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS32 CRUX_ARITH__mul_is32_is08 (
...
CRUX__ResultIS32 CRUX_ARITH__mul_is32_is16 (
...
CRUX__ResultIS32 CRUX_ARITH__mul_is32_is32 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_is32_is64 (
    const IS32 a, const IS64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS32 multiplication = CRUX__as_is64(0);
  CRUX__ResultIS64 promo_result = CRUX__cast_to_is64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_iu08 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_iu16 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_iu32 (
...
CRUX__ResultIU64 CRUX_ARITH__mul_is64_iu64 (
    const IS64 a, const IU64 b) {
  CRUX__Trace trace = CRUX__trace_create();
  IS64 multiplication = CRUX__as_iu64(0);
  CRUX__ResultIU64 promo_result = CRUX__cast_to_iu64(a);
  if (!CRUX__trace_check(promo_result.trace)) {
    CRUX__Fault fault = {
      .error = CRUX__ERROR_VALUE,
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_is08 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_is16 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_is32 (
...
CRUX__ResultIS64 CRUX_ARITH__mul_is64_is64 (
