...
void CRUX__cast_test () {
  ...
  ok((iu08_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_iu16.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_iu16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_iu32.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_iu32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_iu64.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_iu64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_is08.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_is08.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_is16.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_is16.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_is32.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_is32.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_is64.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_is64.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_flp1.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_flp1.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp4_cast_to_flp2.occ == NULL), "Must not have an error.");
  ok((flp4_cast_to_flp2.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu08_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((iu08_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu16_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((iu16_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu32_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((iu32_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((iu64_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((iu64_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is08_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((is08_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is16_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((is16_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is32_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((is32_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((is64_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((is64_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp1_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((flp1_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
  ok((flp2_cast_to_flp4.occ == NULL), "Must not have an error.");
  ok((flp2_cast_to_flp4.value == CRUX__as_iu08(0)), "The result must be 0.");
